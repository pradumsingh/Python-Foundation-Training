...
class Victims(DBConnection):
    ...
    def insert_into(self):
        ...
        insert_query = 'insert into Victims(victim_id, first_name, last_name, dob, gender, address, phone_num) values(%s,%s,%s,%s,%s,%s,%s)'
        data = [(self.victim_id, self.first_name, self.last_name, self.dob, self.gender, self.address, self.phone_num)]
        DBConnection.getConnection()
        stmt = DBConnection.connection.cursor()
    ...
    def update_table(self):
        ...
        data = [(self.first_name, self.last_name, self.dob, self.gender, self.address, self.phone_num, self.victim_id)]
        DBConnection.getConnection()
        stmt = DBConnection.connection.cursor()
